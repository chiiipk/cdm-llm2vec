...
def main():
    ...
    class DistillationTrainer(Trainer):
        ...
        def compute_loss(self, model, inputs, return_outputs=False):
            ...
            loss_logits = (
                loss_function(
                    F.log_softmax(outputs_student.logits.float() / model_args.kd_temperature, dim=-1),
                    F.softmax(avg_teacher_logits.float() / model_args.kd_temperature, dim=-1),
