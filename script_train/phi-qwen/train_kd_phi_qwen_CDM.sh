...
model_name=phi_qwen_dolly_topK100_alpha05_temp20_CDM

train_path=$work_dir/src/run_clm_distill_CDM.py
premodel=$work_dir/checkpoint/qwen05_sft_dolly/checkpoint-1018 # epoch 3
...
HOST_NUM=1
INDEX=0
teacher_model_path=$work_dir/checkpoint/phi3-4b_sft_dolly
TEA2STU_ID_MAP=${your_work_dir}/vocab_mapper/phi2qwen_exact_mapping.json
...
torchrun  --nproc_per_node=$gpu_num \
    ...
    --enable_topk \
    --topk 100 \
    --simi_threadshold 0.3 \
    --gradient_checkpointing True \
    --teacher_to_student_id_mapping $TEA2STU_ID_MAP   \
     2>&1 |tee ${LOG_FILE}
