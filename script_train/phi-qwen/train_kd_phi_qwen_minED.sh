...
model_name=phi_qwen_topK100_revised_dolly-alpha05_temp20_reDyn-bs32_MinED

train_path=$work_dir/src/run_clm_MinED.py
...
TEA2STU_ID_MAP=${your_work_dir}/vocab_mapper/phi2qwen_MinED.json
